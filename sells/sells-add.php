    ...
    <div class="row">
        <form onsubmit="return formOnSubmit();" >
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="mb-3">
                        <?php echo $objFormFields->inputDate("date", "Sell Date", $date, "YYYY-mm-dd", true) ?>
                    </div>
                    <div class="mb-3">
                ...
                <div class="mb-3">
                    <?php
                    $tableHead = ["Product Code","Product Title","Quantity","Selling Price","Total Price","Action"];
...
<script>
    ...
    function templateRow(data){
        ...
        $tableBody.append(`<tr id = "${trNo}" data-id = "${data.id}">
                            ...
                            <td id = "td_qty_${trNo}"><input type = "number" data-price = "${data.sellingPrice}" data-id = "${trNo}" id = "qty_${trNo}" class = "form-control-sm" onkeyup="calTotalPrice(this)"/></td>
    ...
    function calTotalPrice(fieldObject){
        ...
        let sellingPrice = $(fieldObject).attr("data-price");
        $(`#td_totalPrice_${id}`).html(qty*sellingPrice);
    }
